    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Son Testler</Text>
            </View>

            <ScrollView contentContainerStyle={styles.scrollContent}>
                <Text style={styles.introText}>
                    Program sonunda durumunuzu değerlendirmek için soruları cevaplayınız.
                </Text>

                {/* Question 1 */}
                <QuestionCard
                    id={1}
                    text="1. Beslenme alışkanlıklarınızda olumlu bir değişiklik hissediyor musunuz?"
                />

                {/* Question 2 */}
                <QuestionCard
                    id={2}
                    text="2. Günlük egzersiz hedeflerinize ulaşabiliyor musunuz?"
                />

                {/* Question 3 */}
                <QuestionCard
                    id={3}
                    text="3. Kan şekeri takibinizi düzenli olarak yapıyor musunuz?"
                />
